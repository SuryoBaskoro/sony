...
<head>
            ...
            <form class="modal-content" action="signup.php" method="POST">
              <div class="panel">
                ...
                <div class="c-box">
                  ...
                  <div class="clearfix">
                    <button onclick="validasi_signup()" type="submit" class="signupbtn" name="signup">Sign Up </button>
                  </div>
                </div>
              </div>
            </form>
        ...
        <div id="id02" class="modal">
          ...
          <form class="modal-content2" action="Login.php" method="POST">
            <div class="panel">
              ...
              <input type="text" placeholder="Masukkan Username" name="Nama" id="nama" required>
              <input type="password" placeholder="Masukkan Password" name="Password" id="pass" required>
              <div class="c-box2">
                <label>
                  <p><input type="checkbox" checked="checked" name="remember"> Remember me</p>
                </label>
                <div class="clearfix">
                  ...
                  <!-- <button id="validasi_login" type="submit" class="signupbtn2" name="login">Login</button> -->
                  <!-- <button onclick="validasi_login2()" type="submit" class="signupbtn2" name="login">Login</button> -->
                  <!-- <?php
                        if ($_SESSION = ['nama'] == false) {
                          echo "login";
                        }
                        ?> -->
                  <!--<button type="submit" class="signupbtn2" name="login">Login</button> -->
                </div>
              </div>
            </div>
        </div>
  ...
  <script>
    ...
    function validasi_login2() {
      var data = document.getElementById('id02');
      // var data2 = document.getElementById('id02');
      Swal.fire({
        icon: 'error',
        title: 'Selamat! Anda Berhasil Login',
        text: 'Anda Dapat Melakukan Forecast Sekarang!',
  ...
  <!-- <script>
    $(document).ready(function() {
      $('#validasi_login').click(function() {
        e.preventDefault();
        var nama = $('#Nama').val();
        var passw = $('#Password').val();

        if (nama == '<%=session.getAttribute("nama")%>' && passw == '<%=session("pass")%>') {
