...
$et5 = 0.111441593;
// 115
$jumlah1151 = 0.05 + $f5['Kapitalisasi_Pasar'];
$jumlah1152 = $jumlrxy * $f5['Kapitalisasi_Pasar'] - $j5['Kapitalisasi_Pasar'];
$jumlah1153 = $r1 * $et1;
$jumlah1154 = $r2 * $et2;
$jumlah1155 = $r3 * $et3;
$jumlah1156 = $r4 * $et4;
$jumlah1157 = $r5 * $et5;
$jumtot115 = $jumlah1151 + $jumlah1152 - $jumlah1153 - $jumlah1154 - $jumlah1155 - $jumlah1156 - $jumlah1157;
$um = mysqli_query($conn, "SELECT SUM(Kapitalisasi_Pasar) from sampel_data");
$si = mysqli_fetch_array($um);
$aver = $si['SUM(Kapitalisasi_Pasar)'] / 62;
